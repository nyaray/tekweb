...
$(function()
{
  ...
  // $(document).ready(function () {
    function UUMapModule() {
      ...
      var servicelist;
      var StudentadminList;
      var Studentadmin = new Array();
      ...
      var infowindow = new google.maps.InfoWindow(
        ...
        $.get("module/uumap/uumap.xml", function(data, status, xhr){
          ...
          $(locations).each(function(){
            ...
            InstitutionList = $(this).find("institution");
            StudentadminList = $(this).find("studentadmin");
            ...
            Studentadmin[temp] = new Array();
            Institution[temp] = new Array();
            ...
            $(InstitutionList).each(function(){
              Institution[temp][i] = $(this).text();
              i=i+1;
            });
            i=0;
            $(StudentadminList).each(function(){
              Studentadmin[temp][i] = $(this).text();
              i=i+1;
            });
            if(type=="uu")
            {
          ...
          $("#uuMapModule #Locations").change(function () {
            ...
            if($("#uuMapModule #Locations option:selected").val() != $("#uuMapModule #CampusListText").val())
            {
              ...
              if(Studentadmin[ID] != null)
              {
                ...
                {
                  $("#uuMapModule #Information #StudentadminList .list:last ul").append("<li>" +Studentadmin[ID][x] +"</li>");
                  j=j+1;
                  if(j%5 == 0)
                  {
                    $("#uuMapModule #Information #StudentadminList").append("</ul></div><div class=\"list\"><ul>");
                  }
              ...
              if(Institution[ID] != null)
              {
                ...
                {
                  $("#uuMapModule #Information #InstitutionList .list:last ul").append("<li>" +Institution[ID][x] +"</li>");
                  j=j+1;
                  if(j%5 == 0)
                  {
                    $("#uuMapModule #Information #InstitutionList").append("</ul></div><div class=\"list\"><ul>");
                  }

                }
                if(j%5 == 0)
                {
                  $("#uuMapModule #Information #InstitutionList").append("</div></ul>");
                }
              }
